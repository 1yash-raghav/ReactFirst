...
export default class RightContent extends Component {
    ...
    render() {
        return(
            <div className="row z-depth-5 hoverable" style={{borderColor: "#FFFFFF" , alignItems: 'center',justifyContent: 'center', borderRadius:'300px', elevation: 10, backgroundColor: "#000000", margin: "40px"}}>
